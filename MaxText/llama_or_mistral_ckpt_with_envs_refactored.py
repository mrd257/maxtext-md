...
if __name__ == "__main__":
  ...
  base_model_path = "/home/donatim/Meta-Llama-3-70B-Instruct/"
  maxtext_model_path = "gs://scit1565-pedsllm-b5-def/llama3-70b/scanned_chkpt/"
  model_size = "llama3-70b"
  moe_matmul = False
  convert(base_model_path, maxtext_model_path, model_size, moe_matmul)
