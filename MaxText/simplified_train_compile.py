...
"""utilizes: 
jax.eval_shape()
.lower() on jitted function, which is what returns the object named compiled
"""
...
def main(argv: Sequence[str]) -> None:
  ...
  pyconfig.initialize(argv) # think this just changes the config based off the arguments passed
  ...
  #print("in_avals", compiled.in_avals)
  #print("in_tree", compiled.in_tree)
  print("input_layouts", compiled.input_layouts)
  print("input_shardings", compiled.input_shardings)
  #print("out_tree", compiled.out_tree)
  print("output_layouts", compiled.output_layouts)
  print("output_shardings", compiled.output_shardings)
