...
export META_CHECKPOINT_PATH=/mnt/arcus/lab/shared/Meta-Llama-2-7B-Chat/llama-2-7b-chat
...
python3 maxtext/MaxText/llama_or_mistral_ckpt.py --base-model-path ${META_CHECKPOINT_PATH} --model-size llama2-7b --maxtext-model-path ${CONVERTED_CHECKPOINT_PATH}
