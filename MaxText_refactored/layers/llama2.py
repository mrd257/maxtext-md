...
class LlamaDecoderLayer(nn.Module):
  ...
  def __call__(
    ...
    # module
    # introduces
    # axis_rules, logical_to_mesh_axes, logical_to_mesh, with_logical_constraint
    # for appyling jit sharding constraints in terms of “logical named axes” rather than jit’s default mesh axes.
    ...
    # Not sure why lnx is passed twice. Once for query projections and once for kv projections. reused between k and v but not q
